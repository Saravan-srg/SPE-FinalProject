...
function App() {
  ...
  <ul className="dropdown-menu dropdown-menu-end">
    <li><button className="Reset progress" type="button">Action</button></li>
    <li><button className="Export progress" type="button">Another action</button></li>
    <li><button className="Import progress" type="button">Something else here</button></li>
  </ul>
</div>
					</div>
				</div>
